...
d3.json("http://127.0.0.1:5000/ageall").then(function(data) {
    ...
    //console.log(data);
    stateData2 = data;
    console.log(stateData2['NAYARIT']);
    });
...
function optionChanged(newId) {
    ...
    am4core.ready(function() {
        ...
        console.log(stateData2['SINALOA']);
        console.log("se imprimio SIINALOA");
        // Themes begin
      ...
      function Plot(newId){
        ...
        var maleChart = mainContainer.createChild(am4charts.XYChart);
        maleChart.paddingRight = 0;
        //maleChart.data = JSON.parse(JSON.stringify(stateData[newId]));
        maleChart.data = stateData2[newId];
        ...
        var femaleChart = mainContainer.createChild(am4charts.XYChart);
        femaleChart.paddingLeft = 0;
        //femaleChart.data = JSON.parse(JSON.stringify(stateData[newId]));
        femaleChart.data = stateData2[newId];
